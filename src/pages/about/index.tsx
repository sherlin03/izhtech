...
export default function About() {
          ...
          <p className="text-5xl font-extrabold ">
            ...
            Leave us a little info, and we’ll be in touch.
                ...
                >
                  ...
                  <div className="flex-1 pr-10 space-y-10" style={{ scrollBehavior: "smooth" }}>
  {projectsData.map((project, index) => (
    ...
    >
      {/* Dynamic Subtitle Color for Active Project */}
      <p
        className="text-base"
        style={{
          color: activeProject === index ? project.subtitleColor : "#999", // Fallback color for inactive projects
        }}
      >
        {project.subtitle}
      </p>
  ...
  style={{
    borderColor: activeProject === index ? project.buttonOutlineColor : "", // Fallback for inactive buttons
    color: activeProject === index ? project.buttonOutlineColor : "", // Fallback for inactive buttons
  }}
>
  View More
</Button>
  ...
  <div className="sticky top-28 mb-20">
    <img
      ...
      className="w-full h-auto max-w-md transition-opacity duration-700 ease-in-out opacity-100"
      data-nimg="1" 
      decoding="async" 
      loading="lazy" 
      style={{
        transform: `translateY(${activeProject * 10}px)`, // Optional for subtle movement
      }}
    />
  </div>
</div>
